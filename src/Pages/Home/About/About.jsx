    ...
    <div className="hero pt-5 md:pt-20">
      <div className="hero-content flex-col md:flex-row">
        <div className="md:w-1/2 md:h-full relative">
            ...
            <img src={parts} className="w-2/3 rounded shadow-2xl absolute -bottom-16 left-32 border-8 border-white"/>
        </div>
        <div className="md:w-1/2 md:p-5 pt-10 md:pt-0 ">
          <h2 className='text-base md:text-2xl font-bold text-orange-500'>About Us</h2>
          <h2 className="text-2xl md:text-5xl font-bold">We are qualified & of experience in this field</h2>
          ...
          <button className="btn btn-neutral rounded bg-orange-700 text-white">Get Started</button>
        </div>
      </div>
    </div>
  );
